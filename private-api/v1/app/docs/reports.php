 ...
 *  @api {post} /reports Create
 *  @apiName create
 *  @apiGroup Reports
 *
 *  @apiUse ReportsDataParam
 *
 ...
 *  @api {get} /reports/active Get All
 *  @apiName getAll
 *  @apiGroup Reports
 *
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Reports ID
 *  @api {get} /reports/:id/active Read by Reports ID
 *  @apiName getDetail
 *  @apiGroup Reports
 *
 *  @apiSuccess {Number} request_time Request time (timestamp)
