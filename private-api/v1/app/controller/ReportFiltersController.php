...
class ReportFiltersController extends AppController
{
	public function __construct(Slim\Container $ci)
	{
		parent::__construct($ci);
		$this->table = 'report_filters';
	}
	
	/**
	 *  getAll method
	 *  get all report filter data
	 */
	...
	/**
	*	getDetail method
	*	get active detail report filter data by id
	**/
	...
	/**
	 *  update method
	 *  update report filter data by id
	 */
	...
	/**
	 *  delete method
	 *  delete report filter data by id
	 */
