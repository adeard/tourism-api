...
/**
 *  @apiDefine UserDesktopPreferencesData
 *  @apiSuccess {Number} data.id
 *  @apiSuccess {Number} data.user_id
 *  @apiSuccess {String} data.header_bg_color_1
 *  @apiSuccess {String} data.header_bg_color_2
 *  @apiSuccess {String} data.menu_bg_color_1
 *  @apiSuccess {String} data.menu_bg_color_2
 */
 
/**
 *  @apiDefine UserDesktopPreferencesDataParam
 *  @apiParam {Number} user_id
 *  @apiParam {String} header_bg_color_1
 *  @apiParam {String} header_bg_color_2
 *  @apiParam {String} menu_bg_color_1
 *  @apiParam {String} menu_bg_color_2
 */

/**
 *  @apiVersion 1.0.0
 *  @apiDescription Create
 *  @api {post} /user_desktop_preferences Create
 *  @apiName create
 *  @apiGroup User Desktop Preferences
 *
 ...
 *
 *  @apiUse UserDesktopPreferencesDataParam
 *
 ...
 *  @api {put} /user_desktop_preferences/:id Update
 *  @apiName update
 *  @apiGroup User Desktop Preferences
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /user_desktop_preferences/:id Delete
 *  @apiName delete
 *  @apiGroup User Desktop Preferences
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /user_desktop_preferences Get All
 *  @apiName getAll
 *  @apiGroup User Desktop Preferences
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @apiSuccess {String} total_data Response total resource data <b>(success)</b>
 *  @apiSuccess {Object[]} data Response data (Array of Object)
 *  @apiUse UserDesktopPreferencesData
 *  @apiUse Paging
 *
 *  @apiSuccessExample {json} Success-Response:
	HTTP/1.1 200 OK
        ...
        "data": [
            {
                "id": "3",
                "user_id": "1",
                "header_bg_color_1": "test_head",
                "header_bg_color_2": "test_head_2",
                "menu_bg_color_1": "test_menu",
                "menu_bg_color_2": "test_menu_2"
            },
            {
                "id": "4",
                "user_id": "1",
