 ...
 *  @api {delete} /picklists/:id Delete
 *  @apiName delete
 *  @apiGroup Picklists
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /picklists/active Get All
 *  @apiName getAll
 *  @apiGroup Picklists
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Picklists ID
 *  @api {get} /picklists/:id/active Read by Picklists ID
 *  @apiName getDetail
 *  @apiGroup Picklists
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
