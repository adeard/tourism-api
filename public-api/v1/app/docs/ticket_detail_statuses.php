...
/**
 *  @apiDefine TicketDetailStatusesData
...
/**
 *  @apiDefine TicketDetailStatusesDataParam
 ...
 *  @api {post} /ticket_detail_statuses Create
 *  @apiName create
 *  @apiGroup Ticket Detail Statuses
 *
 ...
 *
 *  @apiUse TicketDetailStatusesDataParam
 *
 ...
 *  @api {put} /ticket_detail_statuses/:id Update
 *  @apiName update
 *  @apiGroup Ticket Detail Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /ticket_detail_statuses/:id Delete
 *  @apiName delete
 *  @apiGroup Ticket Detail Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /ticket_detail_statuses/active Get All
 *  @apiName getAll
 *  @apiGroup Ticket Detail Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @apiSuccess {String} total_data Response total resource data <b>(success)</b>
 *  @apiSuccess {Object[]} data Response data (Array of Object)
 *  @apiUse TicketDetailStatusesData
 *  @apiUse Paging
 *
 *  @apiSuccessExample {json} Success-Response:
 	HTTP/1.1 200 OK
    {
        "request_time": 1488781605,
        "execution_time": 0,
        "response_code": 200,
        "status": "success",
        "total_data": 2,
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Get All by Ticket Status
 *  @api {get} /ticket_statuses/:ticket_status_id/ticket_detail_statuses/active Get All by Ticket Status
 *  @apiName getByTicketStatus
 *  @apiGroup Ticket Detail Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
