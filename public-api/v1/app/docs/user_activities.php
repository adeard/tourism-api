...
/**
 *  @apiDefine UserActivitiesDataParam
 ...
 *  @api {post} /user_activities Create
 *  @apiName create
 *  @apiGroup User Activities
 *
 ...
 *
 *  @apiUse UserActivitiesDataParam
 *
 ...
 *  @api {put} /user_activities/:id Update
 *  @apiName update
 *  @apiGroup User Activities
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /user_activities/:id Delete
 *  @apiName delete
 *  @apiGroup User Activities
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /user_activities/active Get All
 *  @apiName getAll
 *  @apiGroup User Activities
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by User Activities ID
 *  @api {get} /user_activities/:id/active Read by User Activities ID
 *  @apiName getDetailUserActivities
 *  @apiGroup User Activities
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
