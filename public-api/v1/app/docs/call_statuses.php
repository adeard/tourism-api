...
/**
 *  @apiDefine CallStatusesDataParam
 ...
 *  @api {post} /call_statuses Create
 *  @apiName create
 *  @apiGroup Call Statuses
 *
 ...
 *  @api {put} /call_statuses/:id Update
 *  @apiName update
 *  @apiGroup Call Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /call_statuses/:id Delete
 *  @apiName delete
 *  @apiGroup Call Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Call Status ID
 *  @api {get} /call_states/:id/active Read by Call Status ID
 *  @apiName getDetailCallStatuses
 *  @apiGroup Call Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
 ...
 *  @apiSuccess {String} total_data Response total resource data <b>(success)</b>
 *  @apiSuccess {Object[]} data Response data (Array of Object)
 *  @apiUse CallStatusesData
 *
 *  @apiSuccessExample {json} Success-Response:
	HTTP/1.1 200 OK
	{
		"request_time": 1482143199,
		"execution_time": 1,
		"response_code": 200,
		"status": "success",
		"total_data": 1,
 ...
 *  @api {get} /directions/:direction_id/call_statuses Get All by Direction ID
 *  @apiName getCallStatusesDirection
 *  @apiGroup Call Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
