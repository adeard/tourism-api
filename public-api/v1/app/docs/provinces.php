 ...
 *  @api {delete} /provinces/:id Delete
 *  @apiName delete
 *  @apiGroup Provinces
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /provinces/active Get All
 *  @apiName getAll
 *  @apiGroup Provinces
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Provinces ID
 *  @api {get} /provinces/:id/active Read by Provinces ID
 *  @apiName getDetailProvinces
 *  @apiGroup Provinces
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
