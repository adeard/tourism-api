...
/**
 *  @apiDefine InformationsData
 *  @apiSuccess {Number} data.id
 *  @apiSuccess {String} data.sort
 *  @apiSuccess {String} data.code
 *  @apiSuccess {String} data.name
 *  @apiSuccess {String} data.pathfile
...
/**
 *  @apiDefine InformationsDataParam
 *  @apiSuccess {String} code
 *  @apiSuccess {String} name
 *  @apiSuccess {String} pathfile
 *  @apiSuccess {String} info
 *  @apiSuccess {Number} is_default
 *  @apiSuccess {Number} is_active
 */
 
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Create
 *  @api {post} /informations Create
 *  @apiName create
 ...
 *  @api {put} /informations/:id Update
 *  @apiName update
 *  @apiGroup Informations
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /informations/:id Delete
 *  @apiName delete
 *  @apiGroup Informations
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /informations/active Get All
 *  @apiName getAll
 *  @apiGroup Informations
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @apiSuccess {String} total_data Response total resource data <b>(success)</b>
 *  @apiSuccess {Object[]} data Response data (Array of Object)
 *  @apiUse InformationsData
 *  @apiUse Paging
 *
 *  @apiSuccessExample {json} Success-Response:
    HTTP/1.1 200 OK
        {
            "request_time": 1488772293,
            "execution_time": 1,
            "response_code": 200,
            "status": "success",
            "total_data": 1,
