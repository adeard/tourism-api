...
/**
 *  @apiDefine CustomerContactTypesData
...
/**
 *  @apiDefine CustomerContactTypesDataParam
 ...
 *  @api {post} /customer_contact_types Create
 *  @apiName create
 *  @apiGroup Customer Contact Types
 *
 ...
 *
 *  @apiUse CustomerContactTypesDataParam
 *
 ...
 *  @api {put} /customer_contact_types/:id Update
 *  @apiName update
 *  @apiGroup Customer Contact Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /customer_contact_types/:id Delete
 *  @apiName delete
 *  @apiGroup Customer Contact Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /customer_contact_types/active Get All
 *  @apiName getAll
 *  @apiGroup Customer Contact Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @apiSuccess {String} total_data Response total resource data <b>(success)</b>
 *  @apiSuccess {Object[]} data Response data (Array of Object)
 *  @apiUse CustomerContactTypesData
 *  @apiUse Paging
 *
 *  @apiSuccessExample {json} Success-Response:
	HTTP/1.1 200 OK
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Customer Contact Types ID
 *  @api {get} /customer_contact_types/:id/active Read by Customer Contact Types ID
 *  @apiName getDetailCustomerContactTypes
 *  @apiGroup Customer Contact Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
