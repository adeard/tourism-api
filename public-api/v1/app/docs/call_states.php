 ...
 *  @api {post} /call_states Create
 *  @apiName create
 *  @apiGroup Call States
 *
 ...
 *  @api {get} /call_states/active Get All
 *  @apiName getAll
 *  @apiGroup Call States
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Call States ID
 *  @api {get} /call_states/:id/active Read by Call States ID
 *  @apiName getDetailCallStates
 *  @apiGroup Call States
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
 ...
 *  @api {delete} /call_states/:id Delete
 *  @apiName delete
 *  @apiGroup Call States
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
