...
/**
 *  @apiDefine TicketPrioritiesData
...
/**
 *  @apiDefine TicketPrioritiesDataParam
 ...
 *  @api {post} /ticket_priorities Create
 *  @apiName create
 *  @apiGroup Ticket Priorities
 *
 ...
 *
 *  @apiUse TicketPrioritiesDataParam
 *
 ...
 *  @api {put} /ticket_priorities/:id Update
 *  @apiName update
 *  @apiGroup Ticket Priorities
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /ticket_priorities/:id Delete
 *  @apiName delete
 *  @apiGroup Ticket Priorities
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /ticket_priorities/active Get All
 *  @apiName getAll
 *  @apiGroup Ticket Priorities
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
