 ...
 *  @api {get} /modules/active Get All
 *  @apiName getAll
 *  @apiGroup Modules
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Modules ID
 *  @api {get} /modules/:id/active Read by Modules ID
 *  @apiName getDetail
 *  @apiGroup Modules
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
