...
/**
 *  @apiDefine BreakHistoriesData
 *  @apiSuccess {Number} data.id
 *  @apiSuccess {Number} data.user_id
 *  @apiSuccess {Number} data.break_reason_id
 *  @apiSuccess {String} data.break_start
 *  @apiSuccess {String} data.break_end
 *  @apiSuccess {Number} data.is_active
 */
 
/**
 *  @apiDefine ViewReportBreakHistoriesData
 *  @apiSuccess {String} data.username
 *  @apiSuccess {String} data.name
 *  @apiSuccess {Number} data.break_time
 *  @apiSuccess {Number} data.resume_time
 *  @apiSuccess {String} data.duration
 */
 
/**
 *  @apiDefine ViewReportBreakHistoriesDataParam
 *  @apiParam {String} username
 *  @apiParam {String} name
 *  @apiParam {String} break_time
 *  @apiParam {String} resume_time
 *  @apiParam {String} duration
 */
 
/**
 *  @apiDefine BreakHistoriesDataParam
 *  @apiParam {Number} user_id
 *  @apiParam {Number} break_reason_id
 *  @apiParam {String} break_start
 *  @apiParam {String} break_end
 ...
 *  @api {post} /break_histories Create
 *  @apiName create
 *  @apiGroup Break Histories
 *
 ...
 *
 *  @apiUse BreakHistoriesDataParam
 *
 ...
 *  @api {put} /break_histories/:id Update
 *  @apiName update
 *  @apiGroup Break Histories
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /break_histories/active Get All
 *  @apiName getAll
 *  @apiGroup Break Histories
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Get All View Report Break Histories
 *  @api {get} /view_break_histories Get All View Report Break Histories
 *  @apiName getAllViewBreakHistories
 *  @apiGroup Break Histories
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
  		Authorization: Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..eo52dbrRTbXs81OmjCQOKE0EnJAy4F-Pw_3UfcBh4e0
 *
 *  @apiParam {String} order="break_time" Order by data field name
 *  @apiParam {String="asc","desc"} sort="asc" (asc, desc)
 *  @apiParam {Number} limit=20 Limit data
 *  @apiParam {Number} page=1 Page number
 *  @apiUse ViewReportBreakHistoriesDataParam
 *
 *  @apiSuccess {Number} request_time Request time (timestamp)
 *  @apiSuccess {Number} execution_time Request execution time (in seconds)
 *  @apiSuccess {Number} response_code Response Code <b>(201 = Created)</b>
 ...
 *  @apiSuccess {String} total_data Response total resource data <b>(success)</b>
 *  @apiSuccess {Object[]} data Response data (Array of Object)
 *  @apiUse ViewReportBreakHistoriesData
 *  @apiUse Paging
 *
 *  @apiSuccessExample {json} Success-Response:
    HTTP/1.1 200 OK
        ...
        "data": [
            {
                "username": "mario",
                "name": "TESTER",
                "break_time": "2017-01-06 17:21:38",
                "resume_time": "2017-01-06 17:21:46",
                "duration": "00:00:08"
            },
            {
                "username": "wahyu",
                "name": "PRAYING",
                "break_time": "2017-01-09 19:35:35",
                "resume_time": "2017-01-09 19:35:44",
                "duration": "00:00:09"
            }
        ],
        "paging": {
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Break Histories ID
 *  @api {get} /break_histories/:id/active Read by Break Histories ID
 *  @apiName getDetailBreakHistories
 *  @apiGroup Break Histories
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
 ...
 *  @api {delete} /break_histories/:id Delete
 *  @apiName delete
 *  @apiGroup Break Histories
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
