...
/**
 *  @apiDefine ContactTypesDataParam
 ...
 *  @api {get} /contact_types/active Get All
 *  @apiName getAll
 *  @apiGroup Contact Types
 *
	...
	HTTP/1.1 200 OK
	{
		...
		"data": [
			...
			},
			{
				...
				"sort": "2",
				"code": "C-02",
				"name": "Assistant Konsumen",
				"info": "Pihak yang dipercaya konsumen",
				"direction_id": "1",
				"is_default": "0",
				"is_active": "1"
			}
 ...
 *  @api {put} /contact_types/:id Update
 *  @apiName update
 *  @apiGroup Contact Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /contact_types/:id Delete
 *  @apiName delete
 *  @apiGroup Contact Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Contact Types ID
 *  @api {get} /contact_types/:id/active Read by Contact Types ID
 *  @apiName getDetail
 *  @apiGroup Contact Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
