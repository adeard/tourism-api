...
/**
 *  @apiDefine InstallLocationsData
...
/**
 *  @apiDefine InstallLocationsDataParam
 ...
 *  @api {post} /install_locations Create
 *  @apiName create
 *  @apiGroup Install Locations
 *
 ...
 *
 *  @apiUse InstallLocationsDataParam
 *
 ...
 *  @api {put} /install_locations/:id Update
 *  @apiName update
 *  @apiGroup Install Locations
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /install_locations/active Get All
 *  @apiName getAll
 *  @apiGroup Install Locations
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Install Locations ID
 *  @api {get} /install_locations/:id/active Read by Install Locations ID
 *  @apiName getDetail
 *  @apiGroup Install Locations
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /install_locations/:id Delete
 *  @apiName delete
 *  @apiGroup Install Locations
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
