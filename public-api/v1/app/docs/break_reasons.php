...
/**
 *  @apiDefine BreakReasonsDataParam
 ...
 *  @api {post} /break_reasons Create
 *  @apiName create
 *  @apiGroup Break Reasons
 *
 ...
 *  @api {put} /break_reasons/:id Update
 *  @apiName update
 *  @apiGroup Break Reasons
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /break_reasons/active Get All
 *  @apiName getAll
 *  @apiGroup Break Reasons
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Break Reasons ID
 *  @api {get} /break_reasons/:id/active Read by Break Reasons ID
 *  @apiName getDetailBreakReasons
 *  @apiGroup Break Reasons
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
 ...
 *  @api {delete} /break_reasons/:id Delete
 *  @apiName delete
 *  @apiGroup Break Reasons
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
