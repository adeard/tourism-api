...
/**
 *  @apiDefine TicketPurchaseStatusData
 *  @apiSuccess {Number} data.id
 *  @apiSuccess {Number} data.sort
 *  @apiSuccess {String} data.code
 *  @apiSuccess {String} data.name
 *  @apiSuccess {String} data.info
 *  @apiSuccess {String} data.is_default
 *  @apiSuccess {String} data.is_active
 */
 
/**
 *  @apiDefine TicketPurchaseStatusDataParam
 *  @apiParam {Number} id
 ...
 *  @api {post} /ticket_purchase_statuses Create
 *  @apiName create
 *  @apiGroup Ticket Purchase Statuses
 *
 ...
 *
 *  @apiUse TicketPurchaseStatusDataParam
 *
 ...
 *  @api {put} /ticket_purchase_statuses/:id Update
 *  @apiName update
 *  @apiGroup Ticket Purchase Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /ticket_purchase_statuses/:id Delete
 *  @apiName delete
 *  @apiGroup Ticket Purchase Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /ticket_purchase_statuses/active Get All
 *  @apiName getAll
 *  @apiGroup Ticket Purchase Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @apiSuccess {String} total_data Response total resource data <b>(success)</b>
 *  @apiSuccess {Object[]} data Response data (Array of Object)
 *  @apiUse TicketPurchaseStatusData
 *  @apiUse Paging
 *
 *  @apiSuccessExample {json} Success-Response:
  	HTTP/1.1 200 OK
    {
        "request_time": 1488787162,
        "execution_time": 0,
        "response_code": 200,
        "status": "success",
        "total_data": 2,
