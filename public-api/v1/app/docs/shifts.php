...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Shifts ID
 *  @api {get} /shifts/:id/active Read by Shifts ID
 *  @apiName getDetailShift
 *  @apiGroup Shifts
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
