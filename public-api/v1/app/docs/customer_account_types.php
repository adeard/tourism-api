 ...
 *  @api {post} /customer_account_types Create
 *  @apiName create
 *  @apiGroup Customer Account Types
 *
 ...
 *
 *  @apiUse CustomerAccountTypesDataParam
 *
 ...
 *  @api {put} /customer_account_types/:id Update
 *  @apiName update
 *  @apiGroup Customer Account Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /customer_account_types/:id Delete
 *  @apiName delete
 *  @apiGroup Customer Account Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /customer_account_types Get All
 *  @apiName getAll
 *  @apiGroup Customer Account Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @apiSuccess {String} total_data Response total resource data <b>(success)</b>
 *  @apiSuccess {Object[]} data Response data (Array of Object)
 *  @apiUse CustomerAccountTypesData
 *  @apiUse Paging
 *
 *  @apiSuccessExample {json} Success-Response:
	HTTP/1.1 200 OK
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Customer Account Types ID
 *  @api {get} /customer_account_types/:id/active Read by Customer Account Types ID
 *  @apiName getDetailCustomerAccountType
 *  @apiGroup Customer Account Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
