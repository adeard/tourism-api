 ...
 *  @api {delete} /spare_parts/:id Delete
 *  @apiName delete
 *  @apiGroup Spare Parts
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /spare_parts/active Get All
 *  @apiName getAll
 *  @apiGroup Spare Parts
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
