...
/**
 *  @apiDefine TicketSubcategoriesData
...
/**
 *  @apiDefine TicketSubcategoriesDataParam
 ...
 *  @api {post} /ticket_subcategories Create
 *  @apiName create
 *  @apiGroup Ticket Subcategories
 *
 ...
 *
 *  @apiUse TicketSubcategoriesDataParam
 *
 ...
 *  @api {put} /ticket_subcategories/:id Update
 *  @apiName update
 *  @apiGroup Ticket Subcategories
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /ticket_subcategories/:id Delete
 *  @apiName delete
 *  @apiGroup Ticket Subcategories
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /ticket_subcategories/active Get All
 *  @apiName getAll
 *  @apiGroup Ticket Subcategories
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @apiSuccess {String} total_data Response total resource data <b>(success)</b>
 *  @apiSuccess {Object[]} data Response data (Array of Object)
 *  @apiUse TicketSubcategoriesData
 *  @apiUse Paging
 *
 *  @apiSuccessExample {json} Success-Response:
    HTTP/1.1 200 OK
