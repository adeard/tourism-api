...
/**
 *  @apiDefine VoiceUploadsData
 *  @apiSuccess {Number} data.id
 *  @apiSuccess {String} data.upload_date
 *  @apiSuccess {String} data.filename
 *  @apiSuccess {String} data.path
 */
 
/**
 *  @apiDefine VoiceUploadsDataParam
 *  @apiParam {String} upload_date
 ...
 *  @api {post} /voice_uploads Create
 *  @apiName create
 *  @apiGroup Voice Uploads
 *
 ...
 *  @api {put} /voice_uploads/:id Update
 *  @apiName update
 *  @apiGroup Voice Uploads
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /voice_uploads/:id Delete
 *  @apiName delete
 *  @apiGroup Voice Uploads
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
