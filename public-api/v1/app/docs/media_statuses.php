...
/**
 *  @apiDefine MediaStatusesDataParam
 ...
 *  @api {post} /media_statuses Create
 *  @apiName create
 *  @apiGroup Media Statuses
 *
 ...
 *  @api {put} /media_statuses/:id Update
 *  @apiName update
 *  @apiGroup Media Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {put} /media_statuses/:id/deactivation Deactivation
 *  @apiName deactivate
 *  @apiGroup Media Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Media Status ID
 *  @api {get} /media_statuses/:id/active Read by Media Status ID
 *  @apiName getDetailMediaStatuses
 *  @apiGroup Media Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Get All by Media ID
 *  @api {get} /media_statuses/:media_status_id/media_status_details/active Get All by Media ID
 *  @apiName getMedia
 *  @apiGroup Media Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Get All by Media ID & Direction ID
 *  @api {get} /medias/:media_id/directions/:direction_id/media_statuses Get All by Media ID & Direction ID
 *  @apiName getMediaDirection
 *  @apiGroup Media Statuses
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
