 ...
 *  @api {post} /user_levels Create
 *  @apiName create
 *  @apiGroup User Levels
 *
 ...
 *  @api {delete} /user_levels/:id Delete
 *  @apiName delete
 *  @apiGroup User Levels
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /user_levels/active Get All
 *  @apiName getAll
 *  @apiGroup User Levels
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by User Levels ID
 *  @api {get} /user_levels/:id/active Read by User Levels ID
 *  @apiName getDetailUserLevel
 *  @apiGroup User Levels
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
