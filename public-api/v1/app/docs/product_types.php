...
/**
 *  @apiDefine ProductTypesDataParam
 ...
 *  @api {get} /product_types/active Get All
 *  @apiName getAll
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Product Types ID
 *  @api {get} /product_types/:id/active Read by Product Types ID
 *  @apiName getDetailProductType
 *  @apiGroup Product Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
 ...
 *  @api {put} /product_types/:id Update
 *  @apiName update
 *  @apiGroup Product Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /product_types/:id Delete
 *  @apiName delete
 *  @apiGroup Product Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
