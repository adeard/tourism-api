...
/**
 *  @apiDefine CallStatusDetailsData
...
/**
 *  @apiDefine CallStatusDetailsDataParam
 ...
 *  @api {post} /call_status_details Create
 *  @apiName create
 *  @apiGroup Call Status Details
 *
 ...
 *
 *  @apiUse CallStatusDetailsDataParam
 *
 ...
 *  @api {put} /call_status_details/:id Update
 *  @apiName update
 *  @apiGroup Call Status Details
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /call_status_details/:id Delete
 *  @apiName delete
 *  @apiGroup Call Status Details
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Get All by Call Status ID
 *  @api {get} /call_statuses/:call_status_id/call_status_details Get All by Call Status ID
 *  @apiName getCallStatus
 *  @apiGroup Call Status Details
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Get All by Direction ID
 *  @api {get} /directions/:direction_id/call_status_details Get All by Direction ID
 *  @apiName getCallStatusDetailDirection
 *  @apiGroup Call Status Details
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
