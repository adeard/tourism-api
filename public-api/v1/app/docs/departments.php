...
/**
 *  @apiDefine DepartmentsDataParam
 ...
 *  @api {delete} /departments/:id Delete
 *  @apiName delete
 *  @apiGroup Departments
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /departments/active Get All
 *  @apiName getAll
 *  @apiGroup Departments
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Departments ID
 *  @api {get} /departments/:id/active Read by Departments ID
 *  @apiName getDetailDepartment
 *  @apiGroup Departments
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
