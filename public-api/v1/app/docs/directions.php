 ...
 *  @api {delete} /directions/:id Delete
 *  @apiName delete
 *  @apiGroup Directions
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /directions/active Get All
 *  @apiName getAll
 *  @apiGroup Directions
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Directions ID
 *  @api {get} /directions/:id/active Read by Directions ID
 *  @apiName getDetailDirections
 *  @apiGroup Directions
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
