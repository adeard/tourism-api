...
/**
 *  @apiDefine MediaOutboundTypesData
...
/**
 *  @apiDefine ViewMediaOutboundTypesData
 *  @apiSuccess {Number} data.id
 *  @apiSuccess {Number} data.media_id
 *  @apiSuccess {Number} data.media_record_id
 *  @apiSuccess {Number} data.outbound_type_id
 ...
 *  @apiSuccess {String} data.outbound_type_name
 */
 
/**
 *  @apiDefine MediaOutboundTypesDataParam
...
/**
 *  @apiDefine ViewMediaOutboundTypesDataParam
 *  @apiParam {Number} media_id
 *  @apiParam {Number} media_record_id
 *  @apiParam {Number} outbound_type_id
 *  @apiParam {String} created
 *  @apiParam {String} media_name
 *  @apiParam {String} outbound_type_name
 */

/**
 *  @apiVersion 1.0.0
 *  @apiDescription Create
 *  @api {post} /media_outbound_types Create
 *  @apiName create
 *  @apiGroup Media Outbound Types
 *
 ...
 *
 *  @apiUse MediaOutboundTypesDataParam
 *
 ...
 *  @api {put} /media_outbound_types/:id Update
 *  @apiName update
 *  @apiGroup Media Outbound Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {put} /media_outbound_types/:id/deactivation Deactivation
 *  @apiName deactivate
 *  @apiGroup Media Outbound Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /media_outbound_types Get All
 *  @apiName getAll
 *  @apiGroup Media Outbound Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @apiUse ViewMediaOutboundTypesDataParam
 *
 *  @apiSuccess {Number} request_time Request time (timestamp)
 *  @apiSuccess {Number} execution_time Request execution time (in seconds)
 *  @apiSuccess {Number} response_code Response Code <b>(201 = Created)</b>
 ...
 *  @apiSuccess {String} total_data Response total resource data <b>(success)</b>
 *  @apiSuccess {Object[]} data Response data (Array of Object)
 *  @apiUse ViewMediaOutboundTypesData
 *  @apiUse Paging
 *
 *  @apiSuccessExample {json} Success-Response:
	HTTP/1.1 200 OK
		...
		"data": [
			{
				...
				"media_record_id": "28",
				"outbound_type_id": "1",
				"created": "2016-11-07 17:22:35",
				"is_active": "0",
				"media_name": "SMS",
				"outbound_type_name": "Konfirmasi status pekerjaan yang sudah dilakukan"
			},
			{
				"id": "2",
				"media_id": "2",
				"media_record_id": "28",
				"outbound_type_id": "2",
				"created": "2016-11-07 17:24:45",
				"is_active": "1",
				"media_name": "SMS",
				"outbound_type_name": "Informasi status sparepart "
			}
		],
		"paging": {
			"current": 1,
 ...
 *  @api {get} /medias/:media_id/media_records/:media_record_id/media_outbound_types Get All by Media ID & Media Record ID
 *  @apiName getOutbound
 *  @apiGroup Media Outbound Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
