...
/**
 *  @apiDefine IdentityTypesDataParam
 ...
 *  @api {post} /identity_types Create
 *  @apiName create
 *  @apiGroup Identity Types
 *
 ...
 *  @api {put} /identity_types/:id Update
 *  @apiName update
 *  @apiGroup Identity Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {delete} /identity_types/:id Delete
 *  @apiName delete
 *  @apiGroup Identity Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /identity_types/active Get All
 *  @apiName getAll
 *  @apiGroup Identity Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Identity Types ID
 *  @api {get} /identity_types/:id/active Read by Identity Types ID
 *  @apiName getDetailIdentityTypes
 *  @apiGroup Identity Types
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
