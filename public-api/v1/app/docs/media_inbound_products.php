...
/**
 *  @apiDefine MediaInboundProductsData
 *  @apiSuccess {Number} data.id
 *  @apiSuccess {Number} data.media_id
 *  @apiSuccess {String} data.media_record_id
...
/**
 *  @apiDefine ViewMediaInboundProductsData
 *  @apiSuccess {Number} data.id
 *  @apiSuccess {Number} data.media_id
 *  @apiSuccess {String} data.media_record_id
 *  @apiSuccess {String} data.product_id
...
/**
 *  @apiDefine MediaInboundProductsDataParam
 *  @apiParam {Number} media_id
 *  @apiParam {String} media_record_id
...
/**
 *  @apiDefine ViewMediaInboundProductsDataParam
 *  @apiParam {Number} media_id
 *  @apiParam {String} media_record_id
 *  @apiParam {String} product_id
 *  @apiParam {String} created
 ...
 *  @api {post} /media_inbound_products Create
 *  @apiName create
 *  @apiGroup Media Inbound Products
 *
 ...
 *
 *  @apiUse MediaInboundProductsDataParam
 *
 ...
 *  @api {put} /media_inbound_products/:id Update
 *  @apiName update
 *  @apiGroup Media Inbound Products
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {put} /media_inbound_products/:id/deactivation Deactivation
 *  @apiName deactivate
 *  @apiGroup Media Inbound Products
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /media_inbound_products Get All
 *  @apiName getAll
 *  @apiGroup Media Inbound Products
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @apiUse ViewMediaInboundProductsDataParam
 *
 *  @apiSuccess {Number} request_time Request time (timestamp)
 *  @apiSuccess {Number} execution_time Request execution time (in seconds)
 *  @apiSuccess {Number} response_code Response Code <b>(201 = Created)</b>
 ...
 *  @apiSuccess {String} total_data Response total resource data <b>(success)</b>
 *  @apiSuccess {Object[]} data Response data (Array of Object)
 *  @apiUse ViewMediaInboundProductsData
 *  @apiUse Paging
 *
 *  @apiSuccessExample {json} Success-Response:
	HTTP/1.1 200 OK
 ...
 *  @api {get} /medias/:media_id/media_records/:media_record_id/media_inbound_products/active Get All by Media ID & Media Record ID
 *  @apiName getInboundProducts
 *  @apiGroup Media Inbound Products
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
 ...
 *  @apiSuccess {String} total_data Response total resource data <b>(success)</b>
 *  @apiSuccess {Object[]} data Response data (Array of Object)
 *  @apiUse MediaInboundProductsData
 *  @apiUse Paging
 *
 *  @apiSuccessExample {json} Success-Response:
	HTTP/1.1 200 OK
