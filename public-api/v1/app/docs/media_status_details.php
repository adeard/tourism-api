...
/**
 *  @apiDefine MediaStatusDetailsData
 *  @apiSuccess {Number} data.id
 *  @apiSuccess {Number} data.media_status_id
...
/**
 *  @apiDefine MediaStatusDetailsDataParam
 *  @apiParam {Number} media_status_id
 ...
 *  @api {post} /media_status_details Create
 *  @apiName create
 *  @apiGroup Media Status Details
 *
 ...
 *
 *  @apiUse MediaStatusDetailsDataParam
 *
 ...
 *  @api {put} /media_status_details/:id Update
 *  @apiName update
 *  @apiGroup Media Status Details
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {put} /media_status_details/:id/deactivation Deactivation
 *  @apiName deactivate
 *  @apiGroup Media Status Details
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 ...
 *  @api {get} /media_status_details/active Get All
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Read by Media Status Details ID
 *  @api {get} /media_status_details/:id Read by Media Status Details ID
 *  @apiName getDetail
 *  @apiGroup Media Status Details
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
...
/**
 *  @apiVersion 1.0.0
 *  @apiDescription Get All by Media Status ID
 *  @api {get} /media_statuses/:media_status_id/media_status_details/active Get All by Media Status ID
 *  @apiName getByMediaStatus
 *  @apiGroup Media Status Details
 *
 * 	@apiHeader {String} Authorization Basis access authorization token
 * 	@apiHeaderExample Header-Example:
