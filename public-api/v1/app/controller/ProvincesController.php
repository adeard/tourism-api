...
class ProvincesController extends AppController
{
	...
	**/
	public function getAll($request, $response)
	{
		...
		$result = $this->parentGetAll($this->table, $clause);

		return $response->withJson($result)
				->withHeader('Content-Type', 'application/json');
	}

	public function getAllByCountries($request, $response, $args)
	{
		$country_id = $args['id'];
		$params = $request->getQueryParams();
		$column = $this->checkColumn($this->db['database']['dbname'], $this->table);
		...
		$result = $this->parentGetAll($this->table, $clause, ['country_id = "'.$country_id.'"']);
	...
	/**
	*	getDetailProvinces method
	*	get detail provinces by id
	**/
	public function getDetailProvinces($request, $response, $args)
	{
		$id = $args['id'];
