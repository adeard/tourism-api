...
class CountriesController extends AppController
{
	...
	**/
	public function getAllByContinent($request, $response, $args)
	{
		$continent_id = $args['continent_id'];
		$params = $request->getQueryParams();
		$column = $this->checkColumn($this->db['database']['dbname'], $this->table);
		$sort = ['ASC', 'DESC'];
		...
		$result = $this->parentGetAll($this->table, $clause, ['continent_id = "'.$continent_id.'"']);
