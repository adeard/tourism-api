...
class DestinationAccountsController extends AppController
{

	public function __construct(Slim\Container $ci)
	{
		parent::__construct($ci);
		$this->table = 'destination_accounts';
	}

    /**
	 *  create method
	 *  create new ticket statuses data
	 */
	...
	**/
    ...
    /**
	*	delete method
	*	delete ticket statuses data by id
	**/
